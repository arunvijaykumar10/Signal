...
const UsageDashboard = () => {
  ...
  const exportReports = [
    {
      campaign: "Summer Promo Campaign",
      date: "May 10, 2025",
      format: "HTML",
      status: "Success",
    },
      ...
      <main className="flex-1 overflow-y-auto p-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600">
            Analytics and performance metrics for Signal Studio
          </p>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-gray-600 space-y-2">
                <p>
                  • Draft activity is up 23% since new prompts were introduced
                  last month.
                </p>
                <p>
                  • Copywriters are producing 15% more content with 8% higher
                  tone scores.
                </p>
                <p>
                  • The "Email Welcome Series" prompt has become your most
                  effective asset.
                </p>
                <p>
                  • Consider additional QA resources as validation queues are
                  growing.
                </p>
              </div>
