...
const ContentDetailView = () => {
  ...
  const content = {
    ...
    versionHistory: [
      {
        id: 1,
        date: "April 23, 2025 - 10:42 AM",
        user: "Amanda Chen",
        action: "Edited content",
      },
      {
        id: 2,
        date: "April 23, 2025 - 9:30 AM",
        user: "Sarah Johnson",
        action: "Approved (Marketing)",
      },
      {
        id: 3,
        date: "April 22, 2025 - 4:32 PM",
        user: "System",
        action: "Tone analysis completed",
      },
      {
        id: 4,
        date: "April 22, 2025 - 2:15 PM",
        user: "Amanda Chen",
    ...
    comments: [
      {
        ...
        user: "Sarah Johnson",
        date: "April 22, 2025",
        text: "The tone is too casual for our enterprise customers. Let's revise the opening paragraph to be more professional.",
        replies: [
          {
            id: 2,
            user: "Amanda Chen",
            date: "April 22, 2025",
            text: "Good point! I've updated the intro to be more formal.",
          },
        ],
      },
      {
        ...
        user: "David Wilson",
        date: "April 23, 2025",
        text: "The legal disclaimer needs to be updated with our new terms. Can we add the standard template from the Snippet Library?",
        replies: [],
      },
    ],
    emailContent: {
    ...
    validationIssues: [
      {
        ...
        severity: "Medium",
        description:
          "Opening greeting could be more formal for enterprise segment",
      },
      {
        id: 2,
        type: "Legal",
        severity: "High",
        description: "Disclaimer needs to be updated with new privacy terms",
      },
    ],
    approvers: [
      {
                        ...
                        <div className="ml-4 flex-1">
                          <div className="flex justify-between">
                            ...
                            <div className="flex items-center">
                              ...
                              <span
                                className={`ml-1 text-sm font-medium ${getApprovalStatusColor(
                                  approver.status
                                )}`}
                              >
                                {approver.status}
                        ...
                        <div className="flex items-start p-3 bg-red-50 rounded-md">
                          ...
                          <div className="ml-3">
                            <p className="text-sm font-medium text-red-800">
                              Legal Disclaimer Outdated
                            </p>
                            <p className="text-sm text-red-700 mt-1">
                              The privacy policy reference needs to be updated
                              to the April 2025 version.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start p-3 bg-yellow-50 rounded-md">
                          ...
                          <div className="ml-3">
                            <p className="text-sm font-medium text-yellow-800">
                              Promotional Claim Warning
                            </p>
                            <p className="text-sm text-yellow-700 mt-1">
                              The "most innovative designs" claim requires
                              substantiation for regulatory compliance.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start p-3 bg-green-50 rounded-md">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-sm text-green-700 mt-1">
                              Discount and pricing information properly
