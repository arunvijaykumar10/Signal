    ...
    <div className="flex-1 max-w-4xl mx-auto w-full p-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Let's set up your brand visual identity in Signal Studio. This will be
          used across all generated content.
        </p>
      </div>
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
          {brandLogo ? (
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-600 mb-2">logo-placeholder.svg</p>
              <button
